...
> = {
  ...
  failed: {
    ...
    badgeClass: "bg-brand-pink/10 text-brand-pink border-brand-pink/20",
    accentClass: "bg-brand-pink",
  },
  other: {
    label: "Other",
    barClass: "bg-muted-foreground/20",
    badgeClass: "bg-secondary text-muted-foreground border-border",
    accentClass: "bg-muted-foreground/20",
  },
};
